  ...
  return (
    <div className={`w-full font-sans ${className} bg-gray-900 rounded-lg`}>
      <div className="relative flex items-center justify-center w-full">
        ...
        <div className={`text-8xl font-black text-green-600 rounded-lg px-8 py-5 text-center flex-1 digital-font tracking-widest ${isActive ? 'text-green-600' : 'text-red-600'}`}>
